...
import { Card, CardContent, CardActions, Typography, Button, Rating } from '@mui/material';
...
const HeroCard = ({ hero }) => {
  ...
  const handleRatingChange = (event, newValue) => {
    setRating(newValue);
    localStorage.setItem(hero.name, newValue); // Сохранение оценки в localStorage
  };

  return (
    <Card>
      <img src={hero.url} alt={hero.name} style={{ width: '100%', maxHeight: 300, objectFit: 'cover' }} />
      <CardContent>
        <Typography variant="h5" component="div">
          {hero.name}
        </Typography>
        <Typography variant="body2" color="text.secondary">
          {hero.alterego}, {hero.universe}
        </Typography>
        <Typography variant="body2" color="text.secondary">
          {hero.occupation}
        </Typography>
        ...
        <Typography variant="body2" color="text.secondary">
          Суперспособности: {hero.superpowers}
        </Typography>
